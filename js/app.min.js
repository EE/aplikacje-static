jQuery.extend(jQuery.easing, {
    ...
    function(t) {
        ...
        var e = function(e) {
            ...
            i = function(t) {
                ...
                a === !0 ? i = 40 : e = 40, n.removeClass("active");
        ...
        var e = {
            init: function(e) {
                ...
                return e = t.extend(i, e), this.each(function() {
                    function i() {
                        "undefined" != typeof window.ontouchstart && (H[0].addEventListener("touchstart", d), H[0].addEventListener("touchmove", p), H[0].addEventListener("touchend", f)), H[0].addEventListener("mousedown", d), H[0].addEventListener("mousemove", p), H[0].addEventListener("mouseup", f), H[0].addEventListener("mouseleave", f), H[0].addEventListener("click", c)
                    }
                    ...
                    function o(t) {
                        return t >= C ? t % C : t < 0 ? o(C + t % C) : t
                    }

                    function r(i) {
                        var n, a, r, s, l, c, u, d = b;
                        if (m = "number" == typeof i ? i : m, b = Math.floor((m + x / 2) / x), r = m - b * x, s = r < 0 ? 1 : -1, l = -s * r * 2 / x, a = C >> 1, e.fullWidth ? u = "translateX(0)" : (u = "translateX(" + (H[0].clientWidth - v) / 2 + "px) ", u += "translateY(" + (H[0].clientHeight - g) / 2 + "px)"), L) {
                            var p = b % C,
                                f = z.find(".indicator-item.active");
                            f.index() !== p && (f.removeClass("active"), z.find(".indicator-item").eq(p).addClass("active"))
                        }
                        for ((!e.noWrap || b >= 0 && b < C) && (c = h[o(b)], t(c).hasClass("active") || (H.find(".carousel-item").removeClass("active"), t(c).addClass("active")), c.style[E] = u + " translateX(" + -r / 2 + "px) translateX(" + s * e.shift * l * n + "px) translateZ(" + e.dist * l + "px)", c.style.zIndex = 0, e.fullWidth ? tweenedOpacity = 1 : tweenedOpacity = 1 - .2 * l, c.style.opacity = tweenedOpacity, c.style.display = "block"), n = 1; n <= a; ++n) e.fullWidth ? (zTranslation = e.dist, tweenedOpacity = n === a && r < 0 ? 1 - l : 1) : (zTranslation = e.dist * (2 * n + l * s), tweenedOpacity = 1 - .2 * (2 * n + l * s)), (!e.noWrap || b + n < C) && (c = h[o(b + n)], c.style[E] = u + " translateX(" + (e.shift + (x * n - r) / 2) + "px) translateZ(" + zTranslation + "px)", c.style.zIndex = -n, c.style.opacity = tweenedOpacity, c.style.display = "block"), e.fullWidth ? (zTranslation = e.dist, tweenedOpacity = n === a && r > 0 ? 1 - l : 1) : (zTranslation = e.dist * (2 * n - l * s), tweenedOpacity = 1 - .2 * (2 * n - l * s)), (!e.noWrap || b - n >= 0) && (c = h[o(b - n)], c.style[E] = u + " translateX(" + (-e.shift + (-x * n - r) / 2) + "px) translateZ(" + zTranslation + "px)", c.style.zIndex = -n, c.style.opacity = tweenedOpacity, c.style.display = "block");
                        if ((!e.noWrap || b >= 0 && b < C) && (c = h[o(b)], c.style[E] = u + " translateX(" + -r / 2 + "px) translateX(" + s * e.shift * l + "px) translateZ(" + e.dist * l + "px)", c.style.zIndex = 0, e.fullWidth ? tweenedOpacity = 1 : tweenedOpacity = 1 - .2 * l, c.style.opacity = tweenedOpacity, c.style.display = "block"), d !== b && "function" == typeof e.onCycleTo) {
                            var y = H.find(".carousel-item").eq(o(b));
                            e.onCycleTo.call(this, y, M)
                        }
                    }

                    function s() {
                        var t, e, i, n;
                        t = Date.now(), e = t - A, A = t, i = m - I, I = m, n = 1e3 * i / (1 + e), O = .8 * n + .2 * O
                    }

                    function l() {
                        var t, i;
                        P && (t = Date.now() - A, i = P * Math.exp(-t / e.duration), i > 2 || i < -2 ? (r(k - i), requestAnimationFrame(l)) : r(k))
                    }

                    function c(i) {
                        if (M) return i.preventDefault(), i.stopPropagation(), !1;
                        if (!e.fullWidth) {
                    ...
                    function u(t) {
                        var i = b % C - t;
                        e.noWrap || (i < 0 ? Math.abs(i + C) < Math.abs(i) && (i += C) : i > 0 && Math.abs(i - C) < i && (i -= C)), i < 0 ? H.trigger("carouselNext", [Math.abs(i)]) : i > 0 && H.trigger("carouselPrev", [i])
                    }

                    function d(t) {
                        w = !0, M = !1, V = !1, T = n(t), S = a(t), O = P = 0, I = m, A = Date.now(), clearInterval(q), q = setInterval(s, 100)
                    }

                    function p(t) {
                        var e, i, o;
                        if (w)
                            if (e = n(t), y = a(t), i = T - e, o = Math.abs(S - y), o < 30 && !V)(i > 2 || i < -2) && (M = !0, T = e, r(m + i));
                            else {
                    ...
                    function f(t) {
                        if (w) return w = !1, clearInterval(q), k = m, (O > 10 || O < -10) && (P = .9 * O, k = m + P), k = Math.round(k / x) * x, e.noWrap && (k >= x * (C - 1) ? k = x * (C - 1) : k < 0 && (k = 0)), P = k - m, A = Date.now(), requestAnimationFrame(l), M && (t.preventDefault(), t.stopPropagation()), !1
                    }
                    var h, v, g, m, b, w, x, C, T, S, P, k, O, E, I, A, q, M, V, z = t('<ul class="indicators"></ul>'),
                        H = t(this),
                        L = H.attr("data-indicators") || e.indicators;
                    if (H.hasClass("initialized")) return t(this).trigger("carouselNext", [1e-6]), !0;
                    if (e.fullWidth) {
                        e.dist = 0;
                        var W = H.find(".carousel-item img").first();
                        W.length ? imageHeight = W.on("load", function() {
                            H.css("height", t(this).height())
                        }) : (imageHeight = H.find(".carousel-item").first().height(), H.css("height", imageHeight)), L && H.find(".carousel-fixed-item").addClass("with-indicators")
                    }
                    H.addClass("initialized"), w = !1, m = k = 0, h = [], v = H.find(".carousel-item").first().innerWidth(), g = H.find(".carousel-item").first().innerHeight(), x = 2 * v + e.padding, H.find(".carousel-item").each(function(e) {
                        if (h.push(t(this)[0]), L) {
                    ...
                    }), L && H.append(z), C = h.length, E = "transform", ["webkit", "Moz", "O", "ms"].every(function(t) {
                        var e = t + "Transform";
                        return "undefined" == typeof document.body.style[e] || (E = e, !1)
                    }), t(window).on("resize.carousel", function() {
                        e.fullWidth ? (v = H.find(".carousel-item").first().innerWidth(), g = H.find(".carousel-item").first().innerHeight(), x = 2 * v + e.padding, m = 2 * b * v, k = m) : r()
                    }), i(), r(m), t(this).on("carouselNext", function(t, e) {
                        void 0 === e && (e = 1), k = x * Math.round(m / x) + x * e, m !== k && (P = k - m, A = Date.now(), requestAnimationFrame(l))
    ...
    function(t) {
        ...
        t.fn.characterCounter = function() {
            return this.each(function() {
                ...
                if (!o.length) {
                    var r = void 0 !== a.attr("data-length");
    ...
    function(t) {
        ...
        t(document).ready(function() {
            ...
            var a = t.extend({}, e, i);
            n.hasAutocomplete = !t.isEmptyObject(a.autocompleteData), this.init = function() {
                var e = 0;
                n.$el.each(function() {
                    var i = t(this),
                        o = Materialize.guid();
                    n.chipId = o, a.data && a.data instanceof Array || (a.data = []), i.data("chips", a.data), i.attr("data-index", e), i.attr("data-initialized", !0), i.hasClass(n.SELS.CHIPS) || i.addClass("chips"), n.chips(i, o), e++
                })
                ...
                e.data("chips").forEach(function(t) {
                    o += n.renderChip(t)
                }), o += '<input id="' + i + '" class="input" placeholder="">', e.html(o), n.setPlaceholder(e);
                var r = e.next("label");
                r.length && (r.attr("for", i), e.data("chips").length && r.addClass("active"));
                var s = t("#" + i);
                n.hasAutocomplete && s.autocomplete({
                    data: a.autocompleteData,
                    limit: a.autocompleteLimit,
                ...
                if (n.isValid(i, e)) {
                    for (var a = n.renderChip(e), o = [], r = i.data("chips"), s = 0; s < r.length; s++) o.push(r[s]);
                    o.push(e), i.data("chips", o), t(a).insertBefore(i.find("input")), i.trigger("chip.add", e), n.setPlaceholder(i)
                }
    ...
    function(t) {
        t.fn.scrollTo = function(e) {
            ...
            return "open" === e ? (this.each(function() {
                ...
                function a(e) {
                    "focus" === e && (l = !0), n(), c.addClass("active"), r.addClass("active"), s.constrainWidth === !0 ? c.css("width", r.outerWidth()) : c.css("white-space", "nowrap");
                    ...
                    if ("left" === p) f = s.gutter, h = r.position().left + f;
                    else if ("right" === p) {
                        var w = r.position().left + r.outerWidth() - c.outerWidth();
                        f = -s.gutter, h = w + f
                    }
                    c.css({
                        position: "absolute",
                ...
                function o() {
                    l = !1, c.fadeOut(s.outDuration), c.removeClass("active"), r.removeClass("active"), t(document).unbind("click." + c.attr("id") + " touchstart." + c.attr("id")), setTimeout(function() {
                        c.css("max-height", "")
                    }, s.outDuration)
                }
                var r = t(this),
                ...
                if (n(), r.after(c), s.hover) {
                    ...
                    l || (r[0] != e.currentTarget || r.hasClass("active") || 0 !== t(e.target).closest(".dropdown-content").length ? r.hasClass("active") && (o(), t(document).unbind("click." + c.attr("id") + " touchstart." + c.attr("id"))) : (e.preventDefault(), s.stopPropagation && e.stopPropagation(), a("click")))
                });
        ...
        t(document).ready(function() {
            ...
            Materialize.updateTextFields = function() {
                ...
                t(e).each(function(e, i) {
                    var n = t(this);
                    t(i).val().length > 0 || i.autofocus || void 0 !== n.attr("placeholder") ? n.siblings("label").addClass("active") : t(i)[0].validity ? n.siblings("label").toggleClass("active", t(i)[0].validity.badInput === !0) : n.siblings("label").removeClass("active")
                })
            };
            ...
            t(document).on("change", s, function(e) {
                ...
                i.length <= 0 && (i = t('<span class="thumb"><span class="value"></span></span>'), t(this).after(i)), i.find(".value").html(t(this).val()), l = !0, t(this).addClass("active"), i.hasClass("active") || i.velocity({
                    ...
                    duration: 300,
                    easing: "easeOutExpo"
                }), "input" !== e.type && (r = void 0 === e.pageX || null === e.pageX ? e.originalEvent.touches[0].pageX - t(this).offset().left : e.pageX - t(this).offset().left, r < 0 ? r = 0 : r > n && (r = n), i.addClass("active").css("left", r)), i.find(".value").html(t(this).val())
                ...
                if (l) {
                    ...
                    i < 0 ? i = 0 : i > a && (i = a), n.addClass("active").css("left", i), n.find(".value").html(n.siblings(s).val())
                }
                ...
                return e = t.extend(i, e), this.each(function() {
                    ...
                    if (!t.isEmptyObject(a)) {
                        ...
                        var u = function(t, e) {
                            ...
                            d = function() {
                                r = 0, c.find(".active").removeClass("active")
                            };
                        n.off("keyup.autocomplete").on("keyup.autocomplete", function(r) {
                            if (o = 0, 13 !== r.which && 38 !== r.which && 40 !== r.which) {
                                var s = n.val().toLowerCase();
                                if (i !== s && (c.empty(), d(), "" !== s))
                                    for (var l in a)
                                        if (a.hasOwnProperty(l) && l.toLowerCase().indexOf(s) !== -1 && l.toLowerCase() !== s) {
                                            if (o >= e.limit) break;
                                            var p = t("<li></li>");
                                            a[l] ? p.append('<img src="' + a[l] + '" class="right circle"><span>' + l + "</span>") : p.append("<span>" + l + "</span>"), c.append(p), u(s, p), o++
                                        }
                                i = s
                            }
                            ...
                            return 13 === i ? (e = c.children("li").eq(r), void(e.length && (e.click(), t.preventDefault()))) : void(38 !== i && 40 !== i || (t.preventDefault(), 38 === i && r > 0 && r--, 40 === i && r < n - 1 && a.length && r++, a.removeClass("active"), c.children("li").eq(r).addClass("active")))
                        }), c.on("click", "li", function() {
                            var i = t(this).text().trim();
                            n.val(i), n.trigger("change"), c.empty(), d(), "function" == typeof e.onAutocomplete && e.onAutocomplete.call(this, i)
                        })
                    }
                })
            }
                ...
                if (!n.hasClass("browser-default")) {
                    ...
                    var m = function(e, i, n) {
                            if (i) {
                                ...
                                var o = t(i);
                                o.addClass("selected"), a && !n || l.scrollTo(o)
                            }
                        },
                        y = [],
                        b = function(e) {
...
Materialize.throttle = function(t, e, i) {
    ...
    i || (i = {});
    var l = function() {
        s = i.leading === !1 ? 0 : getTime(), r = null, o = t.apply(n, a), n = a = null
    };
    return function() {
        var c = getTime();
        s || i.leading !== !1 || (s = c);
        var u = e - (c - s);
        return n = this, a = arguments, u <= 0 ? (clearTimeout(r), r = null, s = c, o = t.apply(n, a), n = a = null) : r || i.trailing === !1 || (r = setTimeout(l, u)), o
    }
};
var Vel;
if (Vel = jQuery ? jQuery.Velocity : $ ? $.Velocity : Velocity, ! function(t, e, i, n) {
        "use strict";
        ...
        function P(t) {
            ...
            return new(e = i ? i : mt ? j : yt ? D : gt ? R : Q)(t, k)
        }
        ...
        function O(t, e) {
            var i = t.session,
                n = e.pointers,
                a = n.length;
            i.firstInput || (i.firstInput = A(e)), a > 1 && !i.firstMultiple ? i.firstMultiple = A(e) : 1 === a && (i.firstMultiple = !1);
            var o = i.firstInput,
                r = i.firstMultiple,
                s = r ? r.center : o.center,
                l = e.center = q(n);
            e.timeStamp = ft(), e.deltaTime = e.timeStamp - o.timeStamp, e.angle = H(s, l), e.distance = z(s, l), E(i, e), e.offsetDirection = V(e.deltaX, e.deltaY), e.scale = r ? W(r.pointers, n) : 1, e.rotation = r ? L(r.pointers, n) : 0, I(i, e);
            var c = t.element;
        ...
        function E(t, e) {
            var i = e.center,
                ...
                a = t.prevDelta || {},
                o = t.prevInput || {};
            (e.eventType === St || o.eventType === kt) && (a = t.prevDelta = {
                x: o.deltaX || 0,
                y: o.deltaY || 0
            }, n = t.offsetDelta = {
                x: i.x,
        ...
        function I(t, e) {
            ...
            if (e.eventType != Ot && (l > Tt || s.velocity === n)) {
                var c = s.deltaX - e.deltaX,
                    u = s.deltaY - e.deltaY,
                    d = M(l, c, u);
                a = d.x, o = d.y, i = pt(d.x) > pt(d.y) ? d.x : d.y, r = V(c, u), t.lastInterval = e
        ...
        function V(t, e) {
            return t === e ? Et : pt(t) >= pt(e) ? t > 0 ? It : At : e > 0 ? qt : Mt
        }
        ...
        function W(t, e) {
            return z(e[0], e[1], Wt) / z(t[0], t[1], Wt)
        }

        function Q() {
            this.evEl = jt, this.evWin = Nt, this.allow = !0, this.pressed = !1, S.apply(this, arguments)
        }

        function j() {
            this.evEl = Ft, this.evWin = Rt, S.apply(this, arguments), this.store = this.manager.session.pointerEvents = []
        }

        function N() {
            this.evTarget = Yt, this.evWin = $t, this.started = !1, S.apply(this, arguments)
        }

        function X(t, e) {
            var i = b(t.touches),
                n = b(t.changedTouches);
            return e & (kt | Ot) && (i = w(i.concat(n), "identifier", !0)), [i, n]
        }

        function D() {
            this.evTarget = Ut, this.targetIds = {}, S.apply(this, arguments)
        }
        ...
        function F(t, e) {
            ...
            for (a = 0; a < r.length;) n[r[a].identifier] && s.push(r[a]), e & (kt | Ot) && delete n[r[a].identifier], a++;
        ...
        function R() {
            ...
            this.touch = new D(this.manager, t), this.mouse = new Q(this.manager, t)
        }
        ...
        function U(t) {
            return t == Mt ? "down" : t == qt ? "up" : t == It ? "left" : t == At ? "right" : ""
        }
        ...
        function ot(t, e) {
            e = e || {}, this.options = l(e, at.defaults), this.options.inputTarget = this.options.inputTarget || t, this.handlers = {}, this.session = {}, this.recognizers = [], this.element = t, this.input = P(this), this.touchAction = new _(this, this.options.touchAction), rt(this, !0), r(e.recognizers, function(t) {
        ...
        c(Q, S, {
            handler: function(t) {
                var e = Qt[t.type];
                e & St && 0 === t.button && (this.pressed = !0), e & Pt && 1 !== t.which && (e = kt), this.pressed && this.allow && (e & kt && (this.pressed = !1), this.callback(this.manager, e, {
                    pointers: [t],
                    changedPointers: [t],
                    pointerType: xt,
                    srcEvent: t
        ...
        t.MSPointerEvent && (Ft = "MSPointerDown", Rt = "MSPointerMove MSPointerUp MSPointerCancel"), c(j, S, {
            handler: function(t) {
                var e = this.store,
                    i = !1,
                ...
                a & St && (0 === t.button || r) ? 0 > s && (e.push(t), s = e.length - 1) : a & (kt | Ot) && (i = !0), 0 > s || (e[s] = t, this.callback(this.manager, a, {
                    pointers: e,
                    changedPointers: [t],
                    pointerType: o,
                    srcEvent: t
        ...
        c(N, S, {
            handler: function(t) {
                ...
                if (e === St && (this.started = !0), this.started) {
                    ...
                    e & (kt | Ot) && 0 === i[0].length - i[1].length && (this.started = !1), this.callback(this.manager, e, {
                        pointers: i[0],
                        changedPointers: i[1],
                        pointerType: bt,
                        srcEvent: t
        ...
        c(D, S, {
            ...
            handler: function(t, e, i) {
                ...
                e & (kt | Ot) && (this.mouse.allow = !0), this.callback(t, e, i)
            },
            destroy: function() {
            ...
            preventDefaults: function(t) {
                if (!Zt) {
                    ...
                    var n = this.actions,
                        ...
                        o = g(n, ne),
                        r = g(n, ie);
                    return a || o && i & Vt || r && i & zt ? this.preventSrc(e) : void 0
                }
            },
        ...
        $.prototype = {
            ...
            process: function(t) {
                var e = this.state,
                    ...
                    n = e & (oe | re),
                    a = this.attrTest(t);
                return n && (i & Ot || !a) ? e | ce : n || a ? i & kt ? e | se : e & oe ? e | re : oe : ue
            }
        }), c(J, Z, {
            defaults: {
                event: "pan",
            ...
            getTouchAction: function() {
                var t = this.options.direction,
                    e = [];
                return t & Vt && e.push(ne), t & zt && e.push(ie), e
            },
            directionTest: function(t) {
                var e = this.options,
                    ...
                    o = t.deltaX,
                    r = t.deltaY;
                return a & e.direction || (e.direction & Vt ? (a = 0 === o ? Et : 0 > o ? It : At, i = o != this.pX, n = Math.abs(t.deltaX)) : (a = 0 === r ? Et : 0 > r ? qt : Mt, i = r != this.pY, n = Math.abs(t.deltaY))), t.direction = a, i && n > e.threshold && a & e.direction
            },
            attrTest: function(t) {
            ...
            process: function(t) {
                ...
                if (this._input = t, !n || !i || t.eventType & (kt | Ot) && !o) this.reset();
            ...
            attrTest: function(t) {
                ...
                return i & (Vt | zt) ? e = t.velocity : i & Vt ? e = t.velocityX : i & zt && (e = t.velocityY), this._super.attrTest.call(this, t) && i & t.direction && t.distance > this.options.threshold && pt(e) > this.options.velocity && t.eventType & kt
            },
            emit: function(t) {
                var e = U(t.direction);
    ...
    }(window, document, "Hammer"), "undefined" == typeof jQuery) {
    var jQuery;
...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
        ...
        easeInOutElastic: function(t, e, i, n, a) {
            ...
            return e < 1 ? -.5 * (s * Math.pow(2, 10 * (e -= 1)) * Math.sin((e * a - o) * (2 * Math.PI) / r)) + i : s * Math.pow(2, -10 * (e -= 1)) * Math.sin((e * a - o) * (2 * Math.PI) / r) * .5 + n + i
        },
            ...
            return this.each(function() {
                ...
                if (!t(this).hasClass("initialized")) {
                    ...
                    l.wrap(c), l.on("click", function() {
                        ...
                        if (o === !1) return e(), !1;
                        if (a && o === !0) return e(), !1;
                        o = !1, l.addClass("active"), a = !0, s.css({
                        ...
                        var m = 0,
                            ...
                            w = 0,
                            x = 0;
                        y > b ? (m = p / d, w = .9 * c, x = .9 * c * m) : (m = d / p, w = .9 * u * m, x = .9 * u), l.hasClass("responsive-img") ? l.velocity({
                            "max-width": w,
                            width: d
                        }, {
                            duration: 0,
                            ...
                            complete: function() {
                                l.css({
                                    ...
                                    height: x,
                                    width: w,
                                    left: t(document).scrollLeft() + c / 2 - l.parent(".material-placeholder").offset().left - w / 2,
                                    top: t(document).scrollTop() + u / 2 - l.parent(".material-placeholder").offset().top - x / 2
                                }, {
                                    duration: r,
                                    queue: !1,
                                    easing: "easeOutQuad",
            ...
            return this.each(function(i) {
                function n(i) {
                    ...
                    var o = a.children("img").first(),
                        ...
                        f = (p - c) / (n + d),
                        h = Math.round(s * f);
                    i && o.css("display", "block"), l > u && c < u + d && o.css("transform", "translate3D(-50%," + h + "px, 0)")
                }
                var a = t(this);
            ...
            var i = function() {
                    for (var e = window.pageYOffset + window.innerHeight, i = 0; i < t.length; i++) {
                        ...
                        if (null !== s) {
                            ...
                            if (e > l + o && n.done !== !0) {
                                if ("function" == typeof r) r.call(this, s);
    ...
    function(t) {
        ...
        function i(i) {
            ...
            t.each(d, function(t, e) {
                ...
                "number" != typeof i && e.triggerHandler("scrollSpy:enter"), e.data("scrollSpy:ticks", l)
        ...
        t.scrollSpy = function(e, n) {
            ...
            return s || (a.on("scroll", d), a.on("resize", d), s = !0), setTimeout(d, 0), e.on("scrollSpy:enter", function() {
        ...
        var e = {
            init: function(e) {
                ...
                e = t.extend(i, e), t(this).each(function() {
                    ...
                    e.draggable ? (o.length && o.remove(), o = t('<div class="drag-target"></div>').attr("data-sidenav", n), t("body").append(o)) : o = t(), "left" == e.edge ? (a.css("transform", "translateX(-100%)"), o.css({
                        left: 0
                    })) : (a.addClass("right-aligned").css("transform", "translateX(100%)"), o.css({
                        right: 0
                    })), a.hasClass("fixed") && window.innerWidth > 992 && a.css("transform", "translateX(0)"), a.hasClass("fixed") && t(window).resize(function() {
                        window.innerWidth > 992 ? 0 !== t("#sidenav-overlay").length && l ? r(!0) : a.css("transform", "translateX(0%)") : l === !1 && ("left" === e.edge ? a.css("transform", "translateX(-100%)") : a.css("transform", "translateX(100%)"))
                    ...
                    e.draggable && (o.on("click", function() {
                        ...
                        if ("touch" == i.gesture.pointerType) {
                            var n = (i.gesture.direction, i.gesture.center.x),
                                o = (i.gesture.center.y, i.gesture.velocityX, t("body")),
                                s = t("#sidenav-overlay"),
                                c = o.innerWidth();
                            if (o.css("overflow", "hidden"), o.width(c), 0 === s.length && (s = t('<div id="sidenav-overlay"></div>'), s.css("opacity", 0).click(function() {
                                    r()
                                }), t("body").append(s)), "left" === e.edge && (n > e.menuWidth ? n = e.menuWidth : n < 0 && (n = 0)), "left" === e.edge) n < e.menuWidth / 2 ? l = !1 : n >= e.menuWidth / 2 && (l = !0), a.css("transform", "translateX(" + (n - e.menuWidth) + "px)");
                            else {
                                n < window.innerWidth - e.menuWidth / 2 ? l = !0 : n >= window.innerWidth - e.menuWidth / 2 && (l = !1);
                                var u = n - e.menuWidth / 2;
                                u < 0 && (u = 0), a.css("transform", "translateX(" + u + "px)")
                            }
                            var d;
                            "left" === e.edge ? (d = n / e.menuWidth, s.velocity({
                                opacity: d
                            }, {
                                duration: 10,
                                queue: !1,
                                easing: "easeOutQuad"
                            })) : (d = Math.abs((n - window.innerWidth) / e.menuWidth), s.velocity({
                                opacity: d
                            }, {
                                duration: 10,
                                queue: !1,
                        ...
                        if ("touch" == i.gesture.pointerType) {
                            var n = t('<div id="sidenav-overlay"></div>'),
                                ...
                                u = c - e.menuWidth,
                                d = c - e.menuWidth / 2;
                            u > 0 && (u = 0), d < 0 && (d = 0), s = !1, "left" === e.edge ? l && r <= .3 || r < -.5 ? (0 !== u && a.velocity({
                                translateX: [0, u]
                            }, {
                                duration: 300,
                                queue: !1,
                        ...
                        if (l === !0) l = !1, s = !1, r();
                            ...
                            var i = t("body"),
                                ...
                                c = i.innerWidth();
                            i.css("overflow", "hidden"), i.width(c), t("body").append(o), "left" === e.edge ? (o.css({
                                width: "50%",
                                right: 0,
                                left: ""
                            }), a.velocity({
        ...
        var e = {
            init: function(e) {
                ...
                return e = t.extend(i, e), this.each(function() {
                    ...
                    function n(t) {
                        t >= c.length ? t = 0 : t < 0 && (t = c.length - 1), u = l.find(".active").index(), u != t && (a = c.eq(u), $caption = a.find(".caption"), a.removeClass("active"), a.velocity({
                            opacity: 0
                        }, {
                    ...
                    u != -1 && (a = c.eq(u)), s.hasClass("fullscreen") || (e.indicators ? s.height(e.height + 40) : s.height(e.height), l.height(e.height)), c.find(".caption").each(function() {
                        i(t(this), 0)
                    ...
                    s.hammer({
                        ...
                        if ("touch" === t.gesture.pointerType) {
                            ...
                            $curr_slide = l.find(".active"), Math.abs(n) > Math.abs(a) && $curr_slide.velocity({
                                translateX: i
                            }, {
                                duration: 50,
                                queue: !1,
                                easing: "easeOutQuad"
                            }), 4 === e && (i > s.innerWidth() / 2 || n < -.65) ? f = !0 : 2 === e && (i < -1 * s.innerWidth() / 2 || n > .65) && (p = !0);
                            var o;
                            p && (o = $curr_slide.next(), 0 === o.length && (o = c.first()), o.velocity({
                                opacity: 1
                            }, {
                                duration: 300,
                                queue: !1,
                                easing: "easeOutQuad"
                            })), f && (o = $curr_slide.prev(), 0 === o.length && (o = c.last()), o.velocity({
                                opacity: 1
                            }, {
                                duration: 300,
                                queue: !1,
    ...
    function(t) {
        var e = {
            init: function(e) {
                ...
                return e = t.extend(i, e), this.each(function() {
                    var i, n, a, o, r, s = t(this),
                        l = t(window).width(),
                        c = s.find("li.tab a"),
                        u = s.width(),
                        d = t(),
                        p = Math.max(u, s[0].scrollWidth) / c.length,
                        f = prev_index = 0,
                        h = !1,
                        v = 300,
                        g = function(t) {
                            return u - t.position().left - t.outerWidth() - s.scrollLeft()
                        },
                        m = function(t) {
                    ...
                    e.swipeable && l > e.responsiveThreshold && (e.swipeable = !1), i = t(c.filter('[href="' + location.hash + '"]')), 0 === i.length && (i = t(this).find("li.tab a.active").first()), 0 === i.length && (i = t(this).find("li.tab a").first()), i.addClass("active"), f = c.index(i), f < 0 && (f = 0), void 0 !== i[0] && (n = t(i[0].hash), n.addClass("active")), s.find(".indicator").length || s.append('<div class="indicator"></div>'), o = s.find(".indicator"), s.append(o), s.is(":visible") && setTimeout(function() {
                        o.css({
                            right: g(i)
                        }), o.css({
                            left: m(i)
                        ...
                        u = s.width(), p = Math.max(u, s[0].scrollWidth) / c.length, f < 0 && (f = 0), 0 !== p && 0 !== u && (o.css({
                            right: g(i)
                        }), o.css({
                            left: m(i)
                        }))
                    }), e.swipeable ? (c.each(function() {
                        var e = t(Materialize.escapeHash(this.hash));
                        e.addClass("carousel-item"), d = d.add(e)
                    }), a = d.wrapAll('<div class="tabs-content carousel"></div>'), d.css("display", ""), t(".tabs-content.carousel").carousel({
                        fullWidth: !0,
                        noWrap: !0,
                        onCycleTo: function(t) {
                            if (!h) {
                                var e = f;
                                f = a.index(t), i = c.eq(f), y(e)
                            }
                        }
                    })) : c.not(i).each(function() {
                        t(Materialize.escapeHash(this.hash)).hide()
                    }), s.on("click", "a", function(a) {
                        if (t(this).parent().hasClass("disabled")) return void a.preventDefault();
                        if (!t(this).attr("target")) {
                            h = !0, u = s.width(), p = Math.max(u, s[0].scrollWidth) / c.length, i.removeClass("active");
                            var o = n;
                            i = t(this), n = t(Materialize.escapeHash(this.hash)), c = s.find("li.tab a");
                            i.position();
                            i.addClass("active"), prev_index = f, f = c.index(t(this)), f < 0 && (f = 0), e.swipeable ? d.length && d.carousel("set", f) : (void 0 !== n && (n.show(), n.addClass("active"), "function" == typeof e.onShow && e.onShow.call(this, n)), void 0 === o || o.is(n) || (o.hide(), o.removeClass("active"))), r = setTimeout(function() {
                                h = !1
                            }, v), y(prev_index), a.preventDefault()
                        }
                    })
                })
            },
        ...
        function a(t) {
            ...
            if (e.classList.add("toast"), i)
                for (var a = i.split(" "), o = 0, r = a.length; o < r; o++) e.classList.add(a[o]);
        ...
        var r = a(t);
        t && o.appendChild(r), r.style.opacity = 0, Vel(r, {
            translateY: "-35px",
            opacity: 1
        }, {
            duration: 300,
        ...
        null != l && (s = setInterval(function() {
            null === r.parentNode && window.clearInterval(s), r.classList.contains("panning") || (l -= 20), l <= 0 && (Vel(r, {
                opacity: 0,
                marginTop: "-40px"
            }, {
                duration: 375,
    ...
    function(t) {
                    ...
                    "mouseenter.tooltip": function(t) {
                        var i = function() {
                            ...
                            "top" === l ? (t = o.offset().top - c - n, i = o.offset().left + r / 2 - f / 2, a = e(i, t, f, c), h = "-10px", d.css({
                                ...
                                top: a.y,
                                left: a.x
                            }), b = Math.SQRT2 * f / parseInt(m), w = Math.SQRT2 * c / parseInt(y), x = Math.max(b, w), u.velocity({
                                translateY: h,
                                translateX: g
                            }, {
                                duration: 350,
        ...
        var e = function(e, i, n, a) {
            var o = e,
                r = i;
            return o < 0 ? o = 4 : o + n > window.innerWidth && (o -= o + n - window.innerWidth), r < 0 ? r = 4 : r + a > window.innerHeight + t(window).scrollTop && (r -= r + a - window.innerHeight), {
                x: o,
                y: r
            }
        };
    ...
    function(t) {
                ...
                t(this).hammer({
                    ...
                    if ("touch" === n.gesture.pointerType) {
                        ...
                        a.velocity({
                            ...
                            queue: !1,
                            easing: "easeOutQuad"
                        }), 4 === o && (r > a.innerWidth() / 2 || s < -.75) && (e = !0), 2 === o && (r < -1 * a.innerWidth() / 2 || s > .75) && (i = !0)
                    }
    ...
    }(jQuery), jQuery.Velocity ? console.log("") : (! function(t) {
        function e(t) {
            var e = t.length,
                n = i.type(t);
        ...
        return function(t, e, i, n) {
            ...
            function l(t, i, n, a) {
                ...
                function f(e) {
                    for (var i = 0, a = 1, o = b - 1; a != o && T[a] <= e; ++a) i += w;
                    --a;
                    var r = (e - T[a]) / (T[a + 1] - T[a]),
                        s = i + r * w,
                        l = c(s, t, n);
                            ...
                            for (var m = Math.min((e - f) / c.duration, 1), y = 0, w = l.length; w > y; y++) {
                                ...
                                if (r(S)) {
                                    ...
                                    for (var O in C)
                                        if ("element" !== O) {
                                            var E, I = C[O],
                                                A = v.isString(I.easing) ? b.Easings[I.easing] : I.easing;
                                            if (1 === m) E = I.endValue;
                                            else {
                                                var q = I.endValue - I.startValue;
                                                if (E = I.startValue + q * A(m, c, q), !h && E === I.currentValue) continue
                                            }
                                            if (I.currentValue = E, "tween" === O) g = E;
                                            else {
                                                if (x.Hooks.registered[O]) {
                                                    var M = x.Hooks.getRoot(O),
                                                        V = r(S).rootPropertyValueCache[M];
                                                    V && (I.rootPropertyValue = V)
                                                }
                                                var z = x.setPropertyValue(S, O, I.currentValue + (0 === parseFloat(E) ? "" : I.unitType), I.rootPropertyValue, I.scrollData);
                                                x.Hooks.registered[O] && (r(S).rootPropertyValueCache[M] = x.Normalizations.registered[M] ? x.Normalizations.registered[M]("extract", null, z[1]) : z[1]), "transform" === z[0] && (P = !0)
                                            }
                                        }
                                    c.mobileHA && r(S).transformCache.translate3d === n && (r(S).transformCache.translate3d = "(0px, 0px, 0px)", P = !0), P && x.flushTransformCache(S)
                                }
                            }
            ...
            var C = function() {
                    ...
                    function t(t) {
                        function d(t, e) {
                            var i = n,
                                a = n,
                                r = n;
                            return v.isArray(t) ? (i = t[0], !v.isArray(t[1]) && /^[\d-]/.test(t[1]) || v.isFunction(t[1]) || x.RegEx.isHex.test(t[1]) ? r = t[1] : (v.isString(t[1]) && !x.RegEx.isHex.test(t[1]) || v.isArray(t[1])) && (a = e ? t[1] : c(t[1], s.duration), t[2] !== n && (r = t[2]))) : i = t, e || (a = a || s.easing), v.isFunction(i) && (i = i.call(o, S, T)), v.isFunction(r) && (r = r.call(o, S, T)), [i || 0, a, r]
                        }
                        ...
                        function m() {
                            ...
                            if (a && n) l.emToPx = z.lastEmToPx, l.percentToPxWidth = z.lastPercentToPxWidth, l.percentToPxHeight = z.lastPercentToPxHeight;
                                ...
                                }), b.CSS.setPropertyValue(c, "paddingLeft", s + "em"), l.percentToPxWidth = z.lastPercentToPxWidth = (parseFloat(x.getPropertyValue(c, "width", null, !0)) || 1) / s, l.percentToPxHeight = z.lastPercentToPxHeight = (parseFloat(x.getPropertyValue(c, "height", null, !0)) || 1) / s, l.emToPx = z.lastEmToPx = (parseFloat(x.getPropertyValue(c, "paddingLeft")) || 1) / s, t.myParent.removeChild(c)
                            }
                            return null === z.remToPx && (z.remToPx = parseFloat(x.getPropertyValue(i.body, "fontSize")) || 16), null === z.vwToPx && (z.vwToPx = parseFloat(e.innerWidth) / 100, z.vhToPx = parseFloat(e.innerHeight) / 100), l.remToPx = z.remToPx, l.vwToPx = z.vwToPx, l.vhToPx = z.vhToPx, b.debug >= 1 && console.log("Unit ratios: " + JSON.stringify(l), o), l
                        }
                        if (s.begin && 0 === S) try {
                            s.begin.call(h, h)
                        } catch (t) {
                        ...
                        if ("scroll" === E) {
                            var w, C, P, k = /^x$/i.test(s.axis) ? "Left" : "Top",
                                I = parseFloat(s.offset) || 0;
                            s.container ? v.isWrapped(s.container) || v.isNode(s.container) ? (s.container = s.container[0] || s.container, w = s.container["scroll" + k], P = w + p(o).position()[k.toLowerCase()] + I) : s.container = null : (w = b.State.scrollAnchor[b.State["scrollProperty" + k]], C = b.State.scrollAnchor[b.State["scrollProperty" + ("Left" === k ? "Top" : "Left")]], P = p(o).offset()[k.toLowerCase()] + I), l = {
                                scroll: {
                                    rootPropertyValue: !1,
                                    startValue: w,
                                    currentValue: w,
                            ...
                            var A = p.extend(!0, {}, r(o).tweensContainer);
                            for (var q in A)
                                if ("element" !== q) {
                                    var M = A[q].startValue;
                                    A[q].startValue = A[q].currentValue = A[q].endValue, A[q].endValue = M, v.isEmptyObject(y) || (A[q].easing = s.easing), b.debug && console.log("reverse tweensContainer (" + q + "): " + JSON.stringify(A[q]), o)
                                }
                            l = A
                        } else if ("start" === E) {
                            var A;
                            r(o).tweensContainer && r(o).isAnimating === !0 && (A = r(o).tweensContainer), p.each(g, function(t, e) {
                            ...
                            for (var V in g) {
                                ...
                                if (r(o).isSVG || "tween" === N || x.Names.prefixCheck(N)[1] !== !1 || x.Normalizations.registered[N] !== n) {
                                    (s.display !== n && null !== s.display && "none" !== s.display || s.visibility !== n && "hidden" !== s.visibility) && /opacity|filter/.test(V) && !j && 0 !== W && (j = 0), s._cacheValues && A && A[V] ? (j === n && (j = A[V].endValue + A[V].unitType), X = r(o).rootPropertyValueCache[N]) : x.Hooks.registered[V] ? j === n ? (X = x.getPropertyValue(o, N), j = x.getPropertyValue(o, V, X)) : X = x.Hooks.templates[N][1] : j === n && (j = x.getPropertyValue(o, V));
                                    var D, F, R, _ = !1;
                                    if (D = f(V, j), j = D[0], R = D[1], D = f(V, W), W = D[0].replace(/^([+-\/*])=/, function(t, e) {
                                            return _ = e, ""
                                        }), F = D[1], j = parseFloat(j) || 0, W = parseFloat(W) || 0, "%" === F && (/^(fontSize|lineHeight)$/.test(V) ? (W /= 100, F = "em") : /^scale/.test(V) ? (W /= 100, F = "") : /(Red|Green|Blue)$/i.test(V) && (W = W / 100 * 255, F = "")), /[\/*]/.test(_)) F = R;
                                    else if (R !== F && 0 !== j)
                                        if (0 === W) F = R;
                                        else {
                                            a = a || m();
                                            ...
                                            switch (R) {
                                                case "%":
                                                    j *= "x" === Y ? a.percentToPxWidth : a.percentToPxHeight;
                                                    break;
                                                case "px":
                                                    break;
                                                default:
                                            ...
                                            switch (F) {
                                                case "%":
                                                    j *= 1 / ("x" === Y ? a.percentToPxWidth : a.percentToPxHeight);
                                                    break;
                                                case "px":
                                                    break;
                                                default:
                                    ...
                                    l[V] = {
                                        ...
                                        unitType: F,
                                        easing: Q
                                    }, b.debug && console.log("tweensContainer (" + V + "): " + JSON.stringify(l[V]), o)
                                } else b.debug && console.log("Skipping [" + N + "] due to a lack of browser support.")
                            }
                            l.element = o
                        }
                        l.element && (x.Values.addClass(o, "velocity-animating"), H.push(l), "" === s.queue && (r(o).tweensContainer = l, r(o).opts = s), r(o).isAnimating = !0, S === T - 1 ? (b.State.calls.push([H, h, s, null, O.resolver]), b.State.isTicking === !1 && (b.State.isTicking = !0, u())) : S++)
                    }
                    var a, o = this,
                ...
                if (v.isWrapped(this) ? (s = !1, f = 0, h = this, l = this) : (s = !0, f = 1, h = w ? arguments[0].elements || arguments[0].e : arguments[0]), h = o(h)) {
                    ...
                    if (!/^(stop|finish)$/i.test(g) && !p.isPlainObject(y)) {
                        var P = f + 1;
                        y = {};
                        for (var k = P; k < arguments.length; k++) v.isArray(arguments[k]) || !/^(fast|normal|slow)$/i.test(arguments[k]) && !/^\d/.test(arguments[k]) ? v.isString(arguments[k]) || v.isArray(arguments[k]) ? y.easing = arguments[k] : v.isFunction(arguments[k]) && (y.complete = arguments[k]) : y.duration = arguments[k]
                    }
                    var O = {
                        promise: null,
                        resolver: null,
                            ...
                            if (!p.isPlainObject(g) || v.isEmptyObject(g)) {
                                if (v.isString(g) && b.Redirects[g]) {
                                    var A = p.extend({}, y),
                                        q = A.duration,
                                        M = A.delay || 0;
                                    return A.backwards === !0 && (h = p.extend(!0, [], h).reverse()), p.each(h, function(t, e) {
                                        parseFloat(A.stagger) ? A.delay = M + parseFloat(A.stagger) * t : v.isFunction(A.stagger) && (A.delay = M + A.stagger.call(e, t, T)), A.drag && (A.duration = parseFloat(q) || (/^(callout|transition)/.test(g) ? 1e3 : m), A.duration = Math.max(A.duration * (A.backwards ? 1 - t / T : (t + 1) / T), .75 * A.duration, 200)), b.Redirects[g].call(e, e, A || {}, t, T, h, O.promise ? O : n)
                                    }), t()
                                }
                                var V = "Velocity: First argument (" + g + ") was not a property map, a known action, or a registered redirect. Aborting.";
                                return O.promise ? O.rejecter(new Error(V)) : console.log(V), t()
                            }
                            E = "start"
                    }
                    var z = {
                    ...
                    if (A.loop = parseInt(A.loop), L = 2 * A.loop - 1, A.loop)
                        for (var W = 0; L > W; W++) {
                            ...
                            W === L - 1 && (Q.display = A.display, Q.visibility = A.visibility, Q.complete = A.complete), C(h, "reverse", Q)
                        }
                    return t()
                }
            };
